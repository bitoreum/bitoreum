...
This mechanism has been integrated into Bitcore-Node-Bitoreum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitoreum/insight-api-bitoreum#web-socket-api](https://github.com/bitoreum/insight-api-bitoreum#web-socket-api)
* API: [https://github.com/bitoreum/insight-api-bitoreum#instantsend-transactions](https://github.com/bitoreum/insight-api-bitoreum#instantsend-transactions)
