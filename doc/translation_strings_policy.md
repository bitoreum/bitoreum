...
This document provides guidelines for internationalization of the Bitoreum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitoreum_en.ts` remains unchanged.
