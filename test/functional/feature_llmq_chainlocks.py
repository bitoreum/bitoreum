...
from test_framework.test_framework import BitoreumTestFramework
...
class LLMQChainLocksTest(BitoreumTestFramework):
    def set_test_params(self):
        self.set_bitoreum_test_params(6, 5, fast_dip3_enforcement=True)
