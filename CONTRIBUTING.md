Contributing to Bitoreum Core
============================

The Bitoreum Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Raptor3um/bitoreum/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Bitoreum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitoreum
Network Protocol consensus changes.

Whether a pull request is merged into Bitoreum Core rests with the project merge
...
Patches that change Bitoreum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitoreum consensus, it must have been
...
The review process is normally fairly responsive on the Bitoreum Core repository, however
...
The project leader is the release manager for each Bitoreum Core release.
