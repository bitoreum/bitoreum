...
/** Utility functions used by the Bitoreum Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitoreum:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load bitoreum specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a bitoreum specific theme is activated (light/dark).*/
