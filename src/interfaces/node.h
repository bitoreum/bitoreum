...
//! Interface for the src/evo part of a bitoreum node (bitoreumd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a bitoreum node (bitoreumd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a bitoreum node (bitoreumd process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a bitoreum node (bitoreumd process).
class Node
{
public:
    virtual ~Node() {}
