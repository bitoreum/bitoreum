...
public:
    CMainParams() {
      ...
      //FindMainNetGenesisBlock(1648947907, 0x20001fff, "main");
        ...
        vSeeds.emplace_back("seed00.bugacoin.com");
        vSeeds.emplace_back("seed01.bugacoin.com");
        vSeeds.emplace_back("seed02.bugacoin.com");
        vSeeds.emplace_back("seed03.bugacoin.com");
        vSeeds.emplace_back("seed04.bugacoin.com");
        vSeeds.emplace_back("seed05.bugacoin.com");
        vSeeds.emplace_back("seed06.bugacoin.com");
        vSeeds.emplace_back("seed07.bugacoin.com");
        vSeeds.emplace_back("seed08.bugacoin.com");
        vSeeds.emplace_back("seed09.bugacoin.com");
        vSeeds.emplace_back("seed10.bugacoin.com");
