...
official/supported Docker Images found at https://hub.docker.com/r/bitoreum/bitoreumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitoreum/bitoreumd-develop/ when changing the above text**